...
function firebaseRetrieve() {
    ...
    database.ref(userId + "/stat").once('value').then(function (snapshot) {
        ...
        zingchart.loadModules('pie', function () {
        ...
        var creditSummary = document.getElementById('creditSummary');
        var gameSummaryString = "Wins: " + noOfWins + " Losses: " + noOfLosses;
        var creditSummaryString = "Average Number of Credits netted: " + netAverage;
